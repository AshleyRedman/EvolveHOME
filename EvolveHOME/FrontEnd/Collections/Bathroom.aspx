<%@ Page Title="Bathroom Products" Language="C#" MasterPageFile="~/Collections/Collection.Master" AutoEventWireup="true" CodeBehind="Bathroom.aspx.cs" Inherits="FrontEnd.Collections.Bathroom" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlDataAdapter sqlDa = new SqlDataAdapter("select Name, Price, ImagePath from tblHomeProducts where Collection LIKE '%Bathroom%';", con);
