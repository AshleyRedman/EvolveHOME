<%@ Page Title="Kitchen Products" Language="C#" MasterPageFile="~/Collections/Collection.Master" AutoEventWireup="true" CodeBehind="Kitchen.aspx.cs" Inherits="FrontEnd.Collections.Kitchen" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlDataAdapter sqlDa = new SqlDataAdapter("select Name, Price, ImagePath from tblHomeProducts where Collection LIKE '%Kitchen%';", con);
