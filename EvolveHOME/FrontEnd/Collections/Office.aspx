<%@ Page Title="Office Products" Language="C#" MasterPageFile="~/Collections/Collection.Master" AutoEventWireup="true" CodeBehind="Office.aspx.cs" Inherits="FrontEnd.Collections.Office" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlDataAdapter sqlDa = new SqlDataAdapter("select Name, Price, ImagePath from tblHomeProducts where Collection LIKE '%Office%';", con);
