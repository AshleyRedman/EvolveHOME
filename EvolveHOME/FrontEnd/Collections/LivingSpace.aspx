<%@ Page Title="Living Space Products" Language="C#" MasterPageFile="~/Collections/Collection.Master" AutoEventWireup="true" CodeBehind="LivingSpace.aspx.cs" Inherits="FrontEnd.Collections.LivingSpace" %>
...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlDataAdapter sqlDa = new SqlDataAdapter("select Name, Price, ImagePath from tblHomeProducts where Collection LIKE '%Living Space%';", con);
