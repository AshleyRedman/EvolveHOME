<%@ Page Title="" Language="C#" MasterPageFile="~/Products/ProductDetail.Master" AutoEventWireup="true" CodeBehind="BiggerSofa.aspx.cs" Inherits="FrontEnd.Products.BiggerSofa" %>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
...

        {
            if (Session["user"] != null) {
                ...
                string Name = "select Name from tblHomeProducts where ProductID = 22";
                string Price = "select Price from tblHomeProducts where ProductID = 22";
                string Type = "select Type from tblHomeProducts where ProductID = 22";
                string Collection = "select Collection from tblHomeProducts where ProductID = 22";
                string Description = "select Description from tblHomeProducts where ProductID = 22";
                string Dimentions = "select Dimentions from tblHomeProducts where ProductID = 22";
                string Image = "select ImagePath from tblHomeProducts where ProductID = 22";
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <aside id="ProductDetail">
        ...
        <div class="ProductPurchase">
            ...
            <div class=".Button"><a class="add-to-cart" href="#" data-name="Double Grey" data-price="760">Add To Basket</a></div>
