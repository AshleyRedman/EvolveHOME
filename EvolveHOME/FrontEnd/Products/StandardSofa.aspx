<%@ Page Title="" Language="C#" MasterPageFile="ProductDetail.master" %>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
...

        {
            if (Session["user"] != null) {
                ...
                string Name = "select Name from tblHomeProducts where ProductID = 20";
                string Price = "select Price from tblHomeProducts where ProductID = 20";
                string Type = "select Type from tblHomeProducts where ProductID = 20";
                string Collection = "select Collection from tblHomeProducts where ProductID = 20";
                string Description = "select Description from tblHomeProducts where ProductID = 20";
                string Dimentions = "select Dimentions from tblHomeProducts where ProductID = 20";
                string Image = "select ImagePath from tblHomeProducts where ProductID = 20";
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <aside id="ProductDetail">
        ...
        <div class="ProductPurchase">
            ...
            <div class=".Button"><a class="add-to-cart" href="#" data-name="Grey Sofa" data-price="560">Add To Basket</a></div>
            <p id="lblMessage"></p>
